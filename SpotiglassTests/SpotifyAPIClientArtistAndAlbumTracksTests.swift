...
final class SpotifyAPIClientArtistAndAlbumTracksTests: XCTestCase {
    ...
    func testAlbumTracksConcurrentRequestsCoalesceByAlbumKey() async throws {
        ...
        XCTAssertEqual(
            requestCount, 1, "Concurrent identical album tracks requests should share one in-flight network call.")
    }
    ...
    func testAlbumTracksRespectsMaxPagesCap() async throws {
        ...
        XCTAssertEqual(
            ...
            "maxPages cap should stop pagination after one HTTP call regardless of `next` URL.")
    }
}
